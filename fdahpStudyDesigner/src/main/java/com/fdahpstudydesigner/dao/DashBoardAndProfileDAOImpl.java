...
public class DashBoardAndProfileDAOImpl implements DashBoardAndProfileDAO {
    ...
    public MasterDataBO getMasterData(String type) {
        ...
        try {
            ...
            query = session.createQuery("select MDBO from MasterDataBO MDBO where MDBO.type =:type").setString("type", type);
    ...
    public String updateProfileDetails(UserBO userBO, int userId) {
        ...
        try {
            ...
            if (updatedUserBo != null) {
                updatedUserBo.setFirstName(null != userBO.getFirstName() ? userBO.getFirstName().trim() : "");
                updatedUserBo.setLastName(null != userBO.getLastName() ? userBO.getLastName().trim() : "");
                updatedUserBo.setUserEmail(null != userBO.getUserEmail() ? userBO.getUserEmail().trim() : "");
                updatedUserBo.setPhoneNumber(null != userBO.getPhoneNumber() ? userBO.getPhoneNumber().trim() : "");
