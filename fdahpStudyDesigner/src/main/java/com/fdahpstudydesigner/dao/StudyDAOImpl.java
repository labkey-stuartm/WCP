...
public class StudyDAOImpl implements StudyDAO {
    ...
    private static final Logger logger = Logger.getLogger(StudyDAOImpl.class.getName());
        ...
        try {
            ...
            if (null != objList && !objList.isEmpty()) {
                ...
                for (Object[] obj : objList) {
                    ...
                    studyPermissionBO.setViewPermission((boolean) obj[3]);
                    ...
                    for (int i = 0; i < userId.length; i++) {
                        ...
                        if (null != studyPermissionBO) {
                            ...
                            if (studyPermissionBO.isViewPermission() != "1".equals(viewPermission[i])) {
                                studyPermissionBO.setViewPermission("1".equals(viewPermission[i]));
                                flag = true;
                            }
