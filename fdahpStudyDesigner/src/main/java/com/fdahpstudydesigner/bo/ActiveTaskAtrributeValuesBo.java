...
@NamedQueries({
  @NamedQuery(
      name = "getAttributeListByActiveTAskId",
      query =
          "From ActiveTaskAtrributeValuesBo ABO where ABO.activeTaskId=:activeTaskId and ABO.active IS NOT NULL and ABO.active=1 order by attributeValueId asc"),
})
public class ActiveTaskAtrributeValuesBo implements Serializable {
  ...
  @Transient private Integer isIdentifierNameStatDuplicate = 0;
  ...
  public void setIsIdentifierNameStatDuplicate(Integer isIdentifierNameStatDuplicate) {
