      ...
      if (emailAddresses != null && !emailAddresses.isEmpty()) {
        ...
        failLogBody =
            FdahpStudyDesignerUtil.genarateEmailContent(
                "mail.audit.failure.content", genarateEmailContentMap);
          ...
          for (PushNotificationBean pushBean : pushNotificationBeans) {
            if (pushBean.getAppId() != null) {
              ...
              if (pushBean.getAppId().equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_FMSA001)
                  || pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_FMSTM001)
                  || pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_COVFH001)
                  || pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_COVFHTEST)) {
                pushBean.setOrgId(FdahpStudyDesignerConstants.ORG_ID_FDAHPH);
              } else if (pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_CCFSIBD001)
                  || pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_CCFSBP001)) {
                pushBean.setOrgId(FdahpStudyDesignerConstants.ORG_ID_CACFND);
              } else if (pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_LIMITJIA001)
                  || pushBean
                      .getAppId()
                      .equalsIgnoreCase(FdahpStudyDesignerConstants.APP_ID_LIMITJP001)) {
