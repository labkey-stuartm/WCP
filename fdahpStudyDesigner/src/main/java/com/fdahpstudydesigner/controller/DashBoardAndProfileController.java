...
public class DashBoardAndProfileController {
  ...
  /**
   * Checking for existing email Ids existing in the DB while creating new users for the application
   *
   * @author BTC
   * @param response , {@link HttpServletResponse}
   * @param email ,Email Id for registering into application
   */
  ...
  /**
   * Method to view session user Details and respective permission allotted to them
   *
   * @author BTC
   * @param request {@link HttpServletRequest}
   * @return {@link ModelAndView}
