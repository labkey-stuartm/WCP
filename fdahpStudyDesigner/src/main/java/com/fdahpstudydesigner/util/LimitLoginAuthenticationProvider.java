...
public class LimitLoginAuthenticationProvider extends DaoAuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) {
		...
		try {
			...
			UserBO userBO = StringUtils.isNotBlank(username) ? loginDAO.getValidUserByEmail(username) : null;
			if (userBO == null) {
			...
			if (userBO != null) {
				if (StringUtils.isNotBlank(userBO.getSalt())) {
					...
					Authentication auth = super.authenticate(
					...
					String hashedPassword = FdahpStudyDesignerUtil
							.getHashedPassword(authentication.getCredentials().toString(), rawSalt);
