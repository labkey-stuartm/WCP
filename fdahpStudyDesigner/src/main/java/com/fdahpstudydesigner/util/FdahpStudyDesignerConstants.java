...
public class FdahpStudyDesignerConstants {
  ...
  public static final String ACTIVETASK_DATE_ERROR_MSG =
      "One or more of the study's active tasks is scheduled to start on a date that has already expired. Please correct the dates and try again.";
  ...
  public static final String COPY_STUDY_FAILURE_MSG =
      "Sorry, a technical error occurred and copy was not successful.";
  ...
  public static final String ANCHOR_ERROR_MSG =
      "One or more activities or resources has a period of visibility that uses anchor date. However, there is no anchor date set for the study yet. Please visit the Questionnaires section, select a question for the anchor date and then try again.";
  ...
  public static final String STUDY_PAUSED_ERR_MSG =
      "The Study ID and App ID cannot be edited when the Study is in a Paused State.";
  public static final String STUDY_ID_APP_ID_ERR_MSG =
      "The Study ID and App ID must be different from the values used in the Test Mode for this study.";
