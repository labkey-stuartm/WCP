...
<script type="text/javascript"
	src="/studybuilder/vendor/dompurify/purify.min.js"></script>
<script>
...
<body class="loading" onload="noBack();"
	...
	<!-- Return to Top -->
	<a href="javascript:void(0)" id="return-to-top"><i
	...
	<script>
		...
		var serverDate = function() {
			return new Date(mytime.getFullYear(), mytime.getMonth(), mytime
					.getDate());
		}
	</script>
</body>
