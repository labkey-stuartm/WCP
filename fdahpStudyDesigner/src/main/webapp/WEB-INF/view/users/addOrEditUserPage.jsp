            ...
            <div class="blue-md-f text-uppercase mb-md">Basic Information</div>
                <div class="col-md-12 p-none">
                    ...
                    <div class="col-md-6 pl-none">
                        <div class="gray-xs-f mb-xs">First Name <c:if test="${actionPage ne 'VIEW_PAGE'}"><span class="requiredStar" style="color: red">*</span></c:if></div>
                    ...
                    <div class="col-md-6 pr-none">
                        <div class="gray-xs-f mb-xs">Last Name <c:if test="${actionPage ne 'VIEW_PAGE'}"><span class="requiredStar" style="color: red">*</span></c:if></div>
                           <div class="form-group">
                 ...
                 <div class="col-md-12 p-none">
                    <!-- form- input-->
                    <div class="col-md-6 pl-none">
                        <div class="gray-xs-f mb-xs">E-mail Address <c:if test="${actionPage ne 'VIEW_PAGE'}"><span class="requiredStar" style="color: red">*</span></c:if></div>
                           <div class="form-group">
                                <input type="text" class="form-control validateUserEmail" name="userEmail" value="${userBO.userEmail}" oldVal="${userBO.userEmail}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" data-pattern-error="E-mail address is invalid" maxlength="100" required <c:if test="${actionPage eq 'VIEW_PAGE' || sessionObject.userId eq userBO.userId || (empty userBO.userPassword && not empty userBO)}">readonly</c:if>/>
                            	<div class="help-block with-errors red-txt"></div>
                            </div>
                    </div>
                    <!-- form- input-->
                    <div class="col-md-6 pr-none">
                        <div class="gray-xs-f mb-xs">Phone Number <c:if test="${actionPage ne 'VIEW_PAGE'}"><span class="requiredStar" style="color: red">*</span></c:if></div>
                           <div class="form-group">
                ...
                <!-- Assign Role Section -->
                <div class="blue-md-f text-uppercase mt-lg mb-md">Assign Role <c:if test="${actionPage ne 'VIEW_PAGE'}"><span class="requiredStar" style="color: red">*</span></c:if></div>
                <div class="col-md-12 p-none">
                    <!-- form- input-->
                    <div class="col-md-6 pl-none">
                           <div class="form-group">
