				...
				<div class="form-group mb-none mt-xs">
					...
					<c:if
						...
						<button type="button"
							...
							style="margin-top: 12px;">Add User</button>
					</c:if>
				</div>
			</div>
					...
					<c:forEach items="${userList}" var="user">
						<tr
							...
							<td><div class="dis-ellipsis"
									title="${fn:escapeXml(user.userFullName)}">${fn:escapeXml(user.userFullName)}</div></td>
							<td>
...
<form:form
	action="/fdahpStudyDesigner/adminUsersView/viewUserDetails.do"
