...
<div class="changeContent">
        ...
        <div class="add_notify_option">
            <div class="form-group shortTitleClass">
                <input autofocus="autofocus" type="text" custAttType="cust"
                       class="form-control shortTitleIdCls" id="shortTitleId" name="shortTitle"
                       value="${fn:escapeXml(activeTaskBo.shortTitle)}"
    ...
    <div>
        <div class="gray-xs-f mb-sm">Display name <small>(150 characters max)</small><span
    ...
    <div class="pt-xs">
        <div class="bullets bor-b-2-gray pt-md">
            ...
            <div class="mt-sm" style="width: 230px;">
                ...
                <input type="hidden" id="inputClockId" class="form-control pr-xlg clock"
                       placeholder="Time" name="taskAttributeValueBos[0].attributeVal"
                       value="23:59"/>
            </div>
        </div>
            <%-- </c:if> --%>
        ...
        <div class="pl-xlg ml-xs bor-l-1-gray mt-lg">
                ...
                <div class="addLineChartBlock_${taskMasterAttributeBo.attributeName}"
                    ...
                    <div class="pb-lg">
                        ...
                        <div class="add_notify_option form-group">
                            <select class="selectpicker aq-select aq-select-form elaborateClass frequencyIdList elaborateClass requireClass"
                        ...
                        <div class="form-group">
                            ...
                            <span class="radio radio-inline">
                                    <input class="rollbackRadioClass" type="radio" id="inlineRadio2"
                                           value="No" name="taskAttributeValueBos[2].rollbackChat">
            ...
            <div class="addLineStaticBlock_${taskMasterAttributeBo.attributeName}"
                ...
                <div>
                    <div class="gray-xs-f mb-sm">Time ranges options available to the mobile app
                        user
                    </div>
                    <div>
