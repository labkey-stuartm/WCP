      ...
      <div class="text-right">
         <div class="black-md-f dis-line pull-left line34">
            ...
            <c:if test="${actionTypeForFormStep == 'edit'}">Edit Question Step</c:if>
         	<c:if test="${actionTypeForFormStep == 'view'}">View Question Step <c:set var="isLive">${_S}isLive</c:set>${not empty isLive?'<span class="eye-inc ml-sm vertical-align-text-top"></span>':''}</c:if>
