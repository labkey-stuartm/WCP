...
<form:form
    ...
    <div class="right-content-body pt-none pl-none pr-none">
        ...
        <div class="tab-content pl-xlg pr-xlg">
            ...
            <input type="hidden" id="mlStatName" value="${questionLangBO.statDisplayName}">
            <input type="hidden" id="mlDisplayUnits" value="${questionLangBO.statDisplayUnits}">
            ...
            <input type="hidden" id="mlResponseTypeId" value="${questionLangBO.responseTypeId}">
                    ...
                    <c:choose>
                        <c:when test="${questionsBo.useAnchorDate}">
								<span class="tool-tip" data-toggle="tooltip" data-html="true"
                                    ...
                                    <c:if test="${not empty questionsBo.isShorTitleDuplicate && (questionsBo.isShorTitleDuplicate gt 0)}">
                                            disabled</c:if>>
                        ...
                        <c:otherwise>
								<span class="tool-tip" data-toggle="tooltip" data-html="true"
									...
									<span class="checkbox checkbox-inline"> <input
                                            ...
                                            name="useAnchorDate"
                                            value="true" ${questionsBo.useAnchorDate ? 'checked':''}
                                    <c:if test="${questionnairesStepsBo.repeatable eq'Yes'}">
                                            disabled </c:if>
                    ...
                    <div class="col-md-6 col-lg-4 p-none">
                        ...
                        <div class="form-group">
                            <input type="text" custAttType="cust"
                                   ...
                                   maxlength="20"
                            <c:if test="${not empty questionsBo.isStatShortNameDuplicate && (questionsBo.isStatShortNameDuplicate gt 0)}">
                                   disabled</c:if>>
                            <div class="help-block with-errors red-txt"></div>
                ...
                <div id="responseTypeDivId">
                    <div id="scaleType" style="display: none">
                        <div class="mt-lg">
                            ...
                            <div>
									<span class="radio radio-info radio-inline p-45"> <input
                                            type="radio" class="ScaleRequired" id="vertical"
                                            value="true"
	                  ...
	                  questionsBo.questionReponseTypeBo.maxDescription)}"
                        ...
                        <div class="row mb-xs">
                            <div class="col-md-6 pl-none">
                                <div class="col-md-9 col-lg-9 p-none">
                                    <div class="gray-xs-f mb-xs">
                                        Default value (slider position) <span
                                            class="requiredStar">*</span>
                                    ...
                                    <div class="form-group col-smthumb-2">
                                        <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                                            ...
                                            <c:if
                                                ...
                                                <div class="textLabelscaleMinImagePathId">Upload
                                                </div>
                                            </c:if>
                                            <c:if
                                                    test="${not empty questionsBo.questionReponseTypeBo.minImage}">
                                                <div class="textLabelscaleMinImagePathId">Change
                                                </div>
                                            </c:if>
                                        </div>
                                    ...
                                    <div class="form-group col-smthumb-2">
                                        <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                                            ...
                                            <c:if
                                                ...
                                                <div class="textLabelscaleMaxImagePathId">Upload
                                                </div>
                                            </c:if>
                                            <c:if
                                                    test="${not empty questionsBo.questionReponseTypeBo.maxImage}">
                                                <div class="textLabelscaleMaxImagePathId">Change
                                                </div>
                                            </c:if>
                                        </div>
                ...
                <div id="Text" style="display: none">
                            ...
                            <div class="col-md-6 col-lg-4 p-none">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control"
                                           name="questionReponseTypeBo.maxLength"
                                           id="textmaxLengthId"
                                           value="${fn:escapeXml(
                                ...
                                <div class="col-md-3 pl-none">
                                    <div class="form-group">
                                        <select name="questionReponseTypeBo.validationCondition"
                                            ...
                                            <option value='' selected>Select</option>
                                            <option value="allow"
                                                ${questionsBo.questionReponseTypeBo.validationCondition eq 'allow' ? 'selected' :''}>
                                                Allow
                                            </option>
                                            <option value="disallow"
                                                ${questionsBo.questionReponseTypeBo.validationCondition eq 'disallow' ? 'selected' :''}>
                                                Disallow
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <select name="questionReponseTypeBo.validationCharacters"
                                            ...
                                            <option value="allcharacters"
                                                ${questionsBo.questionReponseTypeBo.validationCharacters eq 'allcharacters' ? 'selected' :''}>
                                                All
                                                Characters
                                            </option>
                                            <option value="alphabets"
                                                ${questionsBo.questionReponseTypeBo.validationCharacters eq 'alphabets' ? 'selected' :''}>
                                                alphabets
                                            </option>
                                            <option value="numbers"
                                                ${questionsBo.questionReponseTypeBo.validationCharacters eq 'numbers' ? 'selected' :''}>
                                                numbers
                                            </option>
                                            <option value="alphabetsandnumbers"
                                                ${questionsBo.questionReponseTypeBo.validationCharacters eq 'alphabetsandnumbers' ? 'selected' :''}>
                                                alphabets
                                                and numbers
                                            </option>
                                            <option value="specialcharacters"
                                                ${questionsBo.questionReponseTypeBo.validationCharacters eq 'specialcharacters' ? 'selected' :''}>
                                                special
                                                characters
                                            </option>
                                        </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 p-none">
                            ...
                            <div class="form-group">
									<textarea
                                            class="form-control lang-specific<c:if test="${not empty questionsBo.questionReponseTypeBo.validationCondition}">TextRequired</c:if>"
                                            rows="4" name="questionReponseTypeBo.invalidMessage"
                                            id="invalidMessageId" placeholder=""
                        ...
                        <div class="form-group">
                            ...
                            ${questionsBo.questionReponseTypeBo.selectionStyle eq 'After current date' ? 'checked':''}>
									<label for="afterCurrentDateId">After current date</label>
                                                                                 ...
                                                                                 class="DateRequired DateRangeRequired"
                                                                                 id="customDateId"
                                                                                 value="Custom"
                                                                                 name="questionReponseTypeBo.selectionStyle"
                        ...
                        <div class="row">
                            <div class="col-md-6  pl-none">
                                <div class="col-md-8 col-lg-8 p-none">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control"
                                               name="questionReponseTypeBo.defaultDate"
                                               id="defaultDate"
                                        ...
                                        <div class="col-md-2 pl-none col-smthumb-2">
                                            <div class="form-group">
                                                ...
                                                <input
                                                        ...
                                                        id="selectImageFileId${subtype.index}"
                                                        type="file"
                                                        accept=".png, .jpg, .jpeg"
                                                        onchange="readURL(this);">
                                                <input type="hidden"
                                        ...
                                        <div class="form-group">
                                            <div class="sm-thumb-btn"
                                                ...
                                                <c:if
                                                    ...
                                                    <div class="textLabelselectImagePathId0">
                                                        Upload
                                                    </div>
                                                </c:if>
                                                <c:if
                                    ...
                                    <div class="col-md-2 pl-none col-smthumb-2">
                                        <div class="form-group">
                                            ...
                                            <input
                                                    ...
                                                    type="file" data-imageId='1'
                                                    accept=".png, .jpg, .jpeg"
                                                    name="questionResponseSubTypeList[1].imageFile"
                                                    id="imageFileId1" onchange="readURL(this);">
                                            <input
                                                    type="hidden"
                                                    name="questionResponseSubTypeList[1].image"
                                                    id="imagePathId1"
                                        ...
                                        <div class="form-group">
                                            <div class="sm-thumb-btn"
                                                ...
                                                <c:if
                                                    ...
                                                    <div class="textLabelselectImagePathId1">
                                                        Upload
                                                    </div>
                                                </c:if>
                                                <c:if
      ...
      success: function (data) {
        ...
        if (language !== 'en') {
          ...
          if (respType === '1' || respType === '2') {
            ...
            if ($('#repeatable').val() === 'Yes') {
              $('#useAnchorDateId').prop('disabled', true);
            }
          } else if (respType === '13') {
            if ($('#repeatable').val() === 'Yes') {
              $('#useStasticData').prop('disabled', true);
