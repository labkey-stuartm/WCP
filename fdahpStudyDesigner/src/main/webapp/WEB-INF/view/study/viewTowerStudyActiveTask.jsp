...
<div class="changeContent">
    ...
    <div class="form-group">
			<textarea class="form-control" rows="5" id="comment"
                      name="instruction" maxlength="150"
    ...
    <div class="col-md-3 col-lg-3 p-none">
        ...
        <div class="form-group">
            <select class="selectpicker aq-select aq-select-form elaborateClass  requireClass"
                    required name="taskAttributeValueBos[0].attributeVal">
    ...
    <div class="pt-xs">
                    ...
                    <div class="pb-lg">
                        ...
                        <div class="add_notify_option form-group">
                            <select
                                    ...
                                    id="chartId1" name="taskAttributeValueBos[1].timeRangeChart"
                                    title="Select">
                ...
                <div>
                    ...
                    <div class="add_notify_option form-group">
                        <select
                                ...
                                id="" title="Select" name="taskAttributeValueBos[1].uploadTypeStat">
        ...
        <div class="col-md-3 col-lg-3 p-none">
            ...
            <div class="form-group">
                <select class="selectpicker aq-select aq-select-form elaborateClass  requireClass"
                        required name="taskAttributeValueBos[0].attributeVal">
                    <option value="1" ${taskValueAttributeBo.attributeVal eq '1'?'selected':''}>1
                    </option>
                    <option value="2" ${taskValueAttributeBo.attributeVal eq '2'?'selected':''}>2
                    </option>
                    <option value="3" ${taskValueAttributeBo.attributeVal eq '3'?'selected':''}>3
                    </option>
                    <option value="4" ${taskValueAttributeBo.attributeVal eq '4'?'selected':''}>4
                    </option>
                    <option value="5" ${taskValueAttributeBo.attributeVal eq '5'?'selected':''}>5
                    </option>
                    <option value="6" ${taskValueAttributeBo.attributeVal eq '6'?'selected':''}>6
                    </option>
                    <option value="7" ${taskValueAttributeBo.attributeVal eq '7'?'selected':''}>7
                    </option>
                    <option value="8" ${taskValueAttributeBo.attributeVal eq '8'?'selected':''}>8
                    </option>
                </select>
                <div class="help-block with-errors red-txt"></div>
            </div>
                            ...
                            <div class="pb-lg">
                                ...
                                <div class="add_notify_option form-group mb-none">
                                    <select class="selectpicker aq-select aq-select-form elaborateClass frequencyIdList requireClass"
                                            id="chartId"
                                            name="taskAttributeValueBos[1].timeRangeChart"
                                            title="Select">
                                        <c:forEach items="${timeRangeList}" var="timeRangeAttr">
                                ...
                                <div class="add_notify_option">
                                    <div class="form-group">
                                        <input type="text"
                                               ...
                                               id="lineChartId"
                                               name="taskAttributeValueBos[1].titleChat"
                                               maxlength="30"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <select
                                            class="selectpicker aq-select aq-select-form elaborateClass requireClass"
                                            title="Select" id="formulaAppliedStat"
                                            name="taskAttributeValueBos[1].formulaAppliedStat">
                                        <c:forEach items="${activetaskFormulaList}"
                                                   var="activetaskFormula">
          ...
          $(document).ready(function () {
            ...
            $('#number_of_moves_tower_stat_id').on('click', function () {
              if ($(this).is(":checked")) {
                ...
                $('.addLineStaticBlock_number_of_moves_tower').find('.requireClass').attr(
                    'required', true);
