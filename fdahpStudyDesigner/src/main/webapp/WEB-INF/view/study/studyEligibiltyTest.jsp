	...
	<form:form
		...
		<div class="right-content-body">
			...
			<input type="hidden" id="mlQuestion"
				...
				name="sequenceNo" value="${eligibilityTest.sequenceNo}" />
				...
				<div class="col-md-12 p-none mr-md mb-none">
					...
					<div class="form-group col-md-6 pr-none">
						<select class="selectpicker elaborateClass" required
							...
							<option value="true"
								${eligibilityTest.responseYesOption ? 'selected':''}>Pass</option>
							<option value="false"
								${not empty eligibilityTest.responseYesOption && not eligibilityTest.responseYesOption ? 'selected':''}>Fail</option>
						</select>
						<div class="help-block with-errors red-txt"></div>
					</div>
				</div>
				<div class="col-md-12 p-none mr-md mb-none">
					...
					<div class="form-group col-md-6 pr-none">
						<select class="selectpicker elaborateClass form-control" required
							...
							onchange="chkValidChoosedOption()">
							<option value="true"
								${eligibilityTest.responseNoOption ? 'selected':''}>Pass</option>
							<option value="false"
								${not empty eligibilityTest.responseNoOption && not eligibilityTest.responseNoOption ? 'selected':''}>Fail</option>
						</select>
						<div class="help-block with-errors red-txt"></div>
					</div>
				</div>
