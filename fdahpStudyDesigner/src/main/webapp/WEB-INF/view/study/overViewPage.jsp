                                       ...
                                       href="#collapse1" aria-expanded="true">
                                        <div class="text-left dis-inline">
                                            ...
                                            <div class="studyCount"
                                                 id="studyCount1">${studyBo.name}</div>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="dis-inline imgCls">
                                            ...
                                            <div class="form-group mb-none mt-sm">
                                                ...
                                                <input id="1" class="dis-none uploadImg"
                                                       data-imageId='1'
                                ...
                                <div class="panel-title">
                                    ...
                                    <div class="text-left dis-inline">
                                        <div
                                            ...
                                            - ${spbSt.count}</div>
                                        <div class="studyCount"
                                             id="studyCount${spbSt.count}">${fn:escapeXml(studyPageBo.title)}</div>
                                    </div>
                                    <div class="text-right dis-inline pull-right">
                                        <c:if test="${not spbSt.first}">
                                            <span class="sprites_icon delete elaborateHide"
                                                  id="delete"></span>
                                        </c:if>
                                        <span class="ml-lg imageBg"><img class="arrow"
                                                                         src="/fdahpStudyDesigner/images/icons/slide-down.png"/></span>
                            ...
                            <div id="collapse${spbSt.count}"
                                ...
                                <div class="panel-body  pt-none">
                                    ...
                                    <div class="mt-lg">
                                        ...
                                        <div class="form-group ">
                                            <input type="text" class="form-control updateInput"
                                                   id="title${spbSt.count}"
                                                   name="title"
                                                   value="${fn:escapeXml(studyPageBo.title)}"
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('body').find('a[aria-expanded=true]').find('.imageBg').empty().append($("<img />").attr(
        "id", "slideDownId2").attr("class", "arrow").attr("src",
        "/fdahpStudyDesigner/images/icons/slide-up.png"));
    ...
    $(document).on("click", ".removeUrl", function () {
      ...
      $(this).parent().parent().find(".thumb img").attr("src",
          "/fdahpStudyDesigner/images/dummy-img.jpg");
    ...
    $("#addpage").click(function () {
      ...
      $("#accordion").append("<!-- Start panel-->" +
          ...
          + "</div>" +
          "<div class='studyCount' id='studyCount" + count + "'></div>" +
          "</div>" +
          ...
          +
          "<div class=form-group>" +
          "<input type='text' class='form-control updateInput'  id='title" + count
          + "' name='title' required maxlength='50'>" +
          "<div class='help-block with-errors red-txt'></div>" +
          "</div>" +
          "</div>" +
          ...
          + count
          + "' rows='5' required data-error='Please enter plain text of up to 250 characters max.' maxlength='250'></textarea>"
          +
    ...
    $(document).on('show.bs.collapse', '.panel-collapse', function () {
      ...
      $('body').not(this).find('.imageBg').empty().append(
          $("<img />").attr("id", "slideDownId2").attr(
    ...
    $(document).on('hide.bs.collapse', '.panel-collapse', function () {
      $('body').not('a[aria-expanded=true]').find('.imageBg').empty().append($("<img />").attr(
          "id", "slideDownId2").attr("class", "arrow").attr("src",
          "/fdahpStudyDesigner/images/icons/slide-down.png"));
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (language !== 'English') {
          ...
          $('.uploadImgbtn').addClass('cursor-none');
