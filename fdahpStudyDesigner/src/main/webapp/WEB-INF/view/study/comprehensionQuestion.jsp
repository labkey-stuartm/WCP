					...
					<c:if
						...
						<div class="col-md-12 p-none">
							<div class='col-md-6 pl-none'>
								<div class="gray-xs-f mb-xs">
									Answer Options (1 to 150 characters)<span class="requiredStar">*</span>
								</div>
							</div>
							<div class='col-md-3'>
								<div class="gray-xs-f mb-xs">
							...
							<div class='col-md-6 pl-none'>
								<div class='form-group'>
									<input type='text' class='form-control responseOptionClass'
										name="responseList[0].responseOption" id="responseOptionId0"
							...
							<div class='col-md-3'>
								<div class="form-group">
									<select class='selectpicker wid100'
										name="responseList[0].correctAnswer" id="correctAnswerId0"
						...
						<div class="ans-opts col-md-12 p-none" id="1">
							<div class='col-md-6 pl-none'>
								<div class='form-group'>
									<input type='text' class='form-control'
										name="responseList[1].responseOption" id="responseOptionId1"
										required maxlength="150"
										onblur="validateForUniqueValue(this,function(){});"
										onkeypress="resetValue(this);" />
									<div class='help-block with-errors red-txt'></div>
							...
							<div class='col-md-3'>
								<div class="form-group">
									<select class='selectpicker wid100'
										name="responseList[1].correctAnswer" id="correctAnswerId1"
										required data-error='Please choose one option'>
										<option value=''>Select</option>
										<option value="true">Yes</option>
										<option value="false">No</option>
								...
								<div class='col-md-3'>
									<div class="form-group">
										<select class='selectpicker wid100' required
											...
											<option value=''>Select</option>
											<option value="true"
												${responseBo.correctAnswer ? 'selected':''}>Yes</option>
											<option value="false"
												${responseBo.correctAnswer eq false ? 'selected':''}>No</option>
										</select>
										<div class='help-block with-errors red-txt'></div>
									</div>
								</div>
			...
			<div>
				...
				<div class="form-group">
					<span class="radio radio-info radio-inline p-45"> <input
						...
						id="inlineRadio2" value="true" name="structureOfCorrectAns"
