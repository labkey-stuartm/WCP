                        ...
                        <div class="col-md-4 p-none">
                            ...
                            <div class="form-group mb-xs">
                                <select
                                        ...
                                        id="healthkitDatatypeId"
                                        name="questionsBo.healthkitDatatype"
                ...
                <div id="responseTypeDivId">
                    ...
                    <div id="ContinuousScale" style="display: none">
                        ...
                        <div class="row mb-xs">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-6 col-lg-4 p-none">
                                    <div class="gray-xs-f mb-xs">
                                        Max Fraction Digits <span class="requiredStar">*</span>
                                        <span
                                                class="ml-xs sprites_v3 filled-tooltip"
                                                data-toggle="tooltip"
                            ...
                            <div class="row">
                                <div class="col-md-6 pl-none">
                                    <div class="col-md-8 col-lg-8 p-none">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                   name="questionReponseTypeBo.minDate"
                                                   id="minDateId"
                            ...
                            <div class="row">
                                <div class="col-md-6  pl-none">
                                    <div class="col-md-8 col-lg-8 p-none">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                   name="questionReponseTypeBo.maxDate"
                                                   id="maxDateId"
                    ...
                    <div id="TextChoice" style="display: none;">
                        <div class="mt-lg">
                            ...
                            <div>
									<span class="radio radio-info radio-inline p-45"> <input
                                            type="radio" class="TextChoiceRequired"
                                            id="singleSelect"
                                            value="Single"
                                            name="questionReponseTypeBo.selectionStyle"
                                        ...
                                        <div class="mt-xlg text-choice" id="${subtype.index}">
                                            ...
                                            <div class="col-md-12 p-none display__flex__">
                                                <div class="col-md-10 pl-none">
                                                    <div class="gray-xs-f mb-xs">Description(1 to
                                                        150
                                                        characters)
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="mt-lg">
                                        <div>
												<span class="gray-xs-f mb-xs pr-md">Is this field
													mandatory for the participant to fill in ?</span>
                                            <span
                                                    class="radio radio-info radio-inline pr-md"> <input
                                            ...
                                            <div class="form-group">
                                                <div class="sm-thumb-btn"
                                                    ...
                                                    <c:if
                                                        ...
                                                        <div class="textLabelimagePathId0">Upload
                                                        </div>
                                                    </c:if>
                                                    <c:if
                                                            test="${not empty questionnairesStepsBo.questionResponseSubTypeList[0].image}">
                                                        <div class="textLabelimagePathId0">Change
                                                        </div>
                                                    </c:if>
                                                </div>
                                                <input
                                        ...
                                        <c:if test="${questionnaireBo.branching}">
                                            <div class="col-md-2 col-lg-2 pl-none">
                                                <div class="form-group">
                                                    <select
                                                            name="questionResponseSubTypeList[0].destinationStepId"
                                                            id="destinationImageChoiceStepId0"
                                                            class="selectpicker">
                                                        <option value="" selected>select</option>
                                                        <c:forEach items="${destinationStepList}"
                                                                   var="destinationStep">
                                            ...
                                            <div class="form-group">
                                                <div class="sm-thumb-btn"
                                                    ...
                                                    <c:if
                                                        ...
                                                        <div class="textLabelimagePathId1">Upload
                                                        </div>
                                                    </c:if>
                                                    <c:if
                                                            test="${not empty questionnairesStepsBo.questionResponseSubTypeList[1].image}">
                                                        <div class="textLabelimagePathId1">Change
                                                        </div>
                                                    </c:if>
                                                </div>
                                                <input
                                ...
                                <div class="col-md-12 p-none">
                                    <div>
											<span class="checkbox checkbox-inline p-45"> <input
                                                    type="checkbox" id="formulaBasedLogicId"
                                                    value="Yes"
                                                        ...
                                                        <div class="numeric__row display__flex__base-webkit"
                                                            ...
                                                            <div class="form-group sm-selection">
                                                                ...
                                                                <input
                                                                        ...
                                                                        id="parentSequenceNoId2"
                                                                        value="1">
                                                            </div>
                                                            <div class="form-group sm__in">
                                                                <input type="text"
                                                                       id="constantValId2" index="2"
                                                        ...
                                                        <div class="numeric__row display__flex__base-webkit"
                                                            ...
                                                            <div class="form-group sm-selection">
                                                                ...
                                                                <input
                                                                        ...
                                                                        id="parentSequenceNoId3"
                                                                        value="1">
                                                            </div>
                                                            <div class="form-group sm__in">
                                                                <input type="text"
                                                                       id="constantValId3" index="3"
