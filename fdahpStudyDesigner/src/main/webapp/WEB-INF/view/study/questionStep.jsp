		...
		<div class="right-content-body pt-none pl-none pr-none">
			<ul class="nav nav-tabs review-tabs gray-bg">
				<li class="stepLevel active"><a data-toggle="tab" href="#sla">Step-level
						Attributes</a></li>
				<li class="questionLevel"><a data-toggle="tab" href="#qla">Question-level
						Attributes</a></li>
						...
						<div class="col-md-6 col-lg-4 p-none">
							...
							<div class="form-group">
								<input type="text" custAttType="cust"
									...
									<c:if test="${not empty questionnairesStepsBo.questionsBo.isStatShortNameDuplicate && (questionnairesStepsBo.questionsBo.isStatShortNameDuplicate gt 0)}"> disabled</c:if>
									maxlength="20">
								<div class="help-block with-errors red-txt"></div>
										...
										<div class="col-md-3 pl-none">
											<div class="form-group">
												<select name="questionReponseTypeBo.validationCondition"
													...
													<option value='' selected>Select</option>
													<option value="allow"
														${questionnairesStepsBo.questionReponseTypeBo.validationCondition eq 'allow' ? 'selected' :''}>Allow</option>
													<option value="disallow"
														${questionnairesStepsBo.questionReponseTypeBo.validationCondition eq 'disallow' ? 'selected' :''}>Disallow</option>
												</select>
											</div>
											<div class="help-block with-errors red-txt"></div>
										</div>
											...
											<div class="form-group">
												<select name="questionReponseTypeBo.validationCharacters"
													...
													<option value="allcharacters"
														${questionnairesStepsBo.questionReponseTypeBo.validationCharacters eq 'allcharacters' ? 'selected' :''}>All
														Characters</option>
													<option value="alphabets"
														${questionnairesStepsBo.questionReponseTypeBo.validationCharacters eq 'alphabets' ? 'selected' :''}>alphabets</option>
													<option value="numbers"
														${questionnairesStepsBo.questionReponseTypeBo.validationCharacters eq 'numbers' ? 'selected' :''}>numbers</option>
													<option value="alphabetsandnumbers"
														${questionnairesStepsBo.questionReponseTypeBo.validationCharacters eq 'alphabetsandnumbers' ? 'selected' :''}>alphabets
														and numbers</option>
													<option value="specialcharacters"
														${questionnairesStepsBo.questionReponseTypeBo.validationCharacters eq 'specialcharacters' ? 'selected' :''}>special
														characters</option>
												</select>
												<div class="help-block with-errors red-txt"></div>
											</div>
										...
										<div class="form-group">
											<select
												...
												<c:forEach items="${destinationStepList}"
													var="destinationStep">
													<option value="${destinationStep.stepId}"
														${questionnairesStepsBo.questionResponseSubTypeList[0].destinationStepId eq destinationStep.stepId ? 'selected' :''}>Step
														${destinationStep.sequenceNo} :
														${destinationStep.stepShortTitle}</option>
												</c:forEach>
												<option value="0"
													${questionnairesStepsBo.questionResponseSubTypeList[0].destinationStepId eq 0 ? 'selected' :''}>Completion
													Step</option>
											</select>
											<div class="help-block with-errors red-txt"></div>
										</div>
										...
										<div class="form-group">
											<select
												...
												<c:forEach items="${destinationStepList}"
													var="destinationStep">
													<option value="${destinationStep.stepId}"
														${questionnairesStepsBo.questionResponseSubTypeList[1].destinationStepId eq destinationStep.stepId ? 'selected' :''}>Step
														${destinationStep.sequenceNo} :
														${destinationStep.stepShortTitle}</option>
												</c:forEach>
												<option value="0"
													${questionnairesStepsBo.questionResponseSubTypeList[1].destinationStepId eq 0 ? 'selected' :''}>Completion
													Step</option>
											</select>
											<div class="help-block with-errors red-txt"></div>
										</div>
											...
											<div class="col-md-2 pl-none">
												...
												<div class="form-group">
													<select name="questionResponseSubTypeList[0].exclusive"
														...
														onchange="setExclusiveData(this);">
														<option value="Yes"
															${questionnairesStepsBo.questionResponseSubTypeList[0].exclusive eq 'Yes' ? 'selected' :''}>Yes</option>
														<option value="No"
															${questionnairesStepsBo.questionResponseSubTypeList[0].exclusive eq 'No' ? 'selected' :''}>No</option>
													</select>
													<div class="help-block with-errors red-txt"></div>
												</div>
											</div>
								...
								<div class="textchoiceOtherCls" style="display: none;">
									...
									<div class="mt-xlg">
										...
										<div class="col-md-2 pl-none">
											...
											<div class="form-group">
												<select name="questionReponseTypeBo.otherExclusive" id=""
													title="select" data-error="Please choose one option"
													class="selectpicker textChoiceExclusive <c:if test="${questionnairesStepsBo.questionReponseTypeBo.selectionStyle eq 'Multiple'}">TextChoiceRequired</c:if>"
													<c:if test="${empty questionnairesStepsBo.questionReponseTypeBo.selectionStyle || questionnairesStepsBo.questionReponseTypeBo.selectionStyle eq 'Single'}">disabled</c:if>
													onchange="setOtherExclusiveData(this);">
													<option value="Yes"
														${questionnairesStepsBo.questionReponseTypeBo.otherExclusive eq 'Yes' ? 'selected' :''}>Yes</option>
													<option value="No"
														${questionnairesStepsBo.questionReponseTypeBo.otherExclusive eq 'No' ? 'selected' :''}>No</option>
												</select>
												<div class="help-block with-errors red-txt"></div>
											</div>
										</div>
												...
												<div class="form-group">
													<select name="questionReponseTypeBo.otherDestinationStepId"
														...
														<c:forEach items="${destinationStepList}"
															var="destinationStep">
															<option value="${destinationStep.stepId}"
																${questionnairesStepsBo.questionReponseTypeBo.otherDestinationStepId eq destinationStep.stepId ? 'selected' :''}>Step
																${destinationStep.sequenceNo} :
																${destinationStep.stepShortTitle}</option>
														</c:forEach>
														<option value="0"
															${questionnairesStepsBo.questionReponseTypeBo.otherDestinationStepId eq 0 ? 'selected' :''}>Completion
															Step</option>
													</select>
													<div class="help-block with-errors red-txt"></div>
												</div>
										...
										<div class="col-md-12 p-none display__flex__center">
											<div class="col-md-10 pl-none">
												...
												<div class="form-group">
													<textarea class="form-control"
														name="questionReponseTypeBo.otherDescription" id=""
										...
										<c:forEach
											...
											<div class="image-choice row" id="${subtype.index}">
												...
												<div class="col-md-2 pl-none">
													<div class="form-group">
														<input type="text"
															class="form-control ImageChoiceRequired"
															name="questionResponseSubTypeList[${subtype.index}].text"
														...
														<div class="numeric__define gray__t">
															...
															<div class="form-group sm-selection">
																<select
																	...
																	<option value="" selected>Select</option>
																	<option value=">"
																		${questionnairesStepsBo.questionConditionBranchBoList[0].inputTypeValue eq ">" ? 'selected' :''}>&gt;</option>
																	<option
																		value="<" ${questionnairesStepsBo.questionConditionBranchBoList[0].inputTypeValue eq "<"
																		? 'selected' :''}>&lt;</option>
																	<option value="=="
																		${questionnairesStepsBo.questionConditionBranchBoList[0].inputTypeValue eq "==" ? 'selected' :''}>&equals;</option>
																	<option value="!="
																		${questionnairesStepsBo.questionConditionBranchBoList[0].inputTypeValue eq "!=" ? 'selected' :''}>!=</option>
															...
															<div class="numeric__row display__flex__base-webkit"
																...
																<div class="form-group sm-selection">
																	<select
																		...
																		<option value="" selected>Select</option>
																		<option value="C"
																			${questionnairesStepsBo.questionConditionBranchBoList[0].questionConditionBranchBos[0].inputType eq 'C' ? 'selected' :''}>Constant</option>
																		<option value="F"
																			${questionnairesStepsBo.questionConditionBranchBoList[0].questionConditionBranchBos[0].inputType eq 'F' ? 'selected' :''}>Function</option>
																		<option value="RDE"
																			${questionnairesStepsBo.questionConditionBranchBoList[0].questionConditionBranchBos[0].inputType eq 'RDE' ? 'selected' :''}>Response
																			Data Element (x)</option>
																	</select>
															...
															<div class="numeric__row display__flex__base-webkit"
																...
																<div class="form-group sm-selection">
																	<select
																		...
																		<option value="" selected>Select</option>
																		<option value="C"
																			${questionnairesStepsBo.questionConditionBranchBoList[0].questionConditionBranchBos[1].inputType eq 'C' ? 'selected' :''}>Constant</option>
																		<option value="F"
																			${questionnairesStepsBo.questionConditionBranchBoList[0].questionConditionBranchBos[1].inputType eq 'F' ? 'selected' :''}>Function</option>
																		<option value="RDE"
																			${questionnairesStepsBo.questionConditionBranchBoList[0].questionConditionBranchBos[1].inputType eq 'RDE' ? 'selected' :''}>Response
																			Data Element (x)</option>
																	</select>
																	<div class="mt-sm black-xs-f italic-txt red-txt"
																		...
																		<select
																			...
																			<c:choose>
																				...
																				<c:when
																					...
																					<option value=">"
																						${questionConditionBranchBo.inputTypeValue eq ">" ? 'selected' :''}>&gt;</option>
																					<option
																						value="<" ${questionConditionBranchBo.inputTypeValue eq "<"
																						? 'selected' :''}>&lt;</option>
																					<option value="="
																						${questionConditionBranchBo.inputTypeValue eq "=" ? 'selected' :''}>&equals;</option>
																					<option value="!="
																						${questionConditionBranchBo.inputTypeValue eq "!=" ? 'selected' :''}>!=</option>
																				</c:when>
																				<c:otherwise>
																		...
																		<div class="numeric__row display__flex__base"
																			...
																			<div class="form-group sm-selection">
																				<select
																					...
																					<option value="" selected>Select</option>
																					<option value="C"
																						${questionConditionsSubBranchBo.inputType eq 'C' ? 'selected' :''}>Constant</option>
																					<option value="F"
																						${questionConditionsSubBranchBo.inputType eq 'F' ? 'selected' :''}>Function</option>
																					<option value="RDE"
																						${questionConditionsSubBranchBo.inputType eq 'RDE' ? 'selected' :''}>Response
																						Data Element (x)</option>
																				</select>
																				<div class="mt-sm black-xs-f italic-txt red-txt"
																				...
																				<c:choose>
																					<c:when
																						...
																						<div class="add_varible add_var_hide"
																							...
																							onclick="addVariable(this);">+ Add Variable</div>
																					</c:when>
																					<c:otherwise>
																						<div
...
$(document).ready(function(){
    		  ...
    		  if(resType == "Email"){
    				...
    				if((minValue != '' && maxValue != '') || (minValue == '' && maxValue == '')){
    	   				isValid = true;
	                        ...
	                        $("#numericMaxValueId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
	                        "Please fill out this field"));
    	   				  }
    	     			  if(minValue == ''){
    	     				 $("#numericMinValueId").parent().addClass("has-danger").addClass("has-error");
	                         $("#numericMinValueId").parent().find(".help-block").empty();
	                         $("#numericMinValueId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
	                         "Please fill out this field"));  
    	     			  }
    	   				isValid = false;
    	   				...
    	   				isValid = true;
    	   				  ...
    	   				  if(maxValue == ''){
    	   					if(resType == "Continuous Scale"){
    	                        ...
    	                        $("#continuesScaleMaxDescriptionId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                        "Please fill out this field"));
    	                    }else{
    	                    	$("#scaleMaxDescriptionId").parent().addClass("has-danger").addClass("has-error");
    	                        $("#scaleMaxDescriptionId").parent().find(".help-block").empty();
    	                        $("#scaleMaxDescriptionId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                        "Please fill out this field"));
    	                    }
    	   				  }
    	     			  if(minValue == ''){
    	     				 if(resType == "Continuous Scale"){
    	                         ...
    	                         $("#continuesScaleMinDescriptionId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                         "Please fill out this field"));
    	                     }else{
    	                    	 $("#scaleMinDescriptionId").parent().addClass("has-danger").addClass("has-error");
    	                         $("#scaleMinDescriptionId").parent().find(".help-block").empty();
    	                         $("#scaleMinDescriptionId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                         "Please fill out this field"));
    	                     }  
    	     			  }
    	   				isValid = false;
    	   			...
    	   			if(minImagePath == '' && maxImagePath == '' && ((typeof minImageFile == 'undefined' && typeof maxImageFile == 'undefined') ||  (minImageFile == null && maxImageFile == null))){
    	   				...
    	   				if(maxImagePath == '' && (maxImageFile == '' || typeof maxImageFile == 'undefined' || maxImageFile == null)){
    	   					if(resType == "Continuous Scale"){
    	                        ...
    	                        $("#continuesScaleMaxImagePathId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                        "Please fill out this field"));
    	                    }else{
    	                    	$("#scaleMaxImagePathId").parent().addClass("has-danger").addClass("has-error");
    	                        $("#scaleMaxImagePathId").parent().find(".help-block").empty();
    	                        $("#scaleMaxImagePathId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                        "Please fill out this field"));
    	                    }
    	   				  }
    	     			  if(minImagePath == '' && (minImageFile == '' || typeof minImageFile == 'undefined' || minImageFile == null)){
    	     				 if(resType == "Continuous Scale"){
    	                         ...
    	                         $("#continuesScaleMinImagePathId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                         "Please fill out this field"));
    	                     }else{
    	                    	 $("#scaleMinImagePathId").parent().addClass("has-danger").addClass("has-error");
    	                         $("#scaleMinImagePathId").parent().find(".help-block").empty();
    	                         $("#scaleMinImagePathId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	                         "Please fill out this field")); 
    	                     }  
    	     			  }
    	     			 isImageValid = false;
    		...
    		if(value != ''){
    			if(parseInt(value) >= -10000 && parseInt(value) <= 10000){
        			if(parseInt(value)+1 > parseInt(maxValue)){
                        ...
                        $("#scaleMinValueId").parent().find(".help-block").empty();
                        $("#scaleMinValueId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    		...
    		if(value != ''){
    			if(parseInt(value) >= -10000 && parseInt(value) <= 10000){
        			if(parseInt(value) >= parseInt(minValue)+1 && parseInt(value) <= 10000){
                        ...
                        $("#scaleMaxValueId").parent().find(".help-block").empty();
                        $("#scaleMaxValueId").parent().find(".help-block").append( $("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	            ...
    	            if(parseInt(stepsCount) >= 1 && parseInt(stepsCount) <= 13){
        	            ...
        	            $("#scaleStepId").val(displayStepsCount);
        	             ...
        	             if(parseInt(stepsCount) < 1){
        	            	 $("#displayStepsCount").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
		...
		if(value != '' && stepSize != ''){
			if(parseInt(value) >= 0 && parseInt(value) <= parseInt(stepSize)){
	            ...
	            $("#scaleDefaultValueId").parent().find(".help-block").empty();
	             ...
	             $("#scaleDefaultValueId").parent().find(".help-block").empty();
	             $("#scaleDefaultValueId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	...
    	if(maxValue != ''){
    		if(parseInt(value) >= -10000 && parseInt(value) <= 10000){
    			if(parseInt(value)+1 > parseInt(maxValue)){
                    ...
                    $("#continuesScaleMinValueId").parent().find(".help-block").empty();
                    $("#continuesScaleMinValueId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
                    "Please enter an integer number in the range (Min, 10000)"));
            	}else{
            		$("#continuesScaleMinValueId").parent().removeClass("has-danger").removeClass("has-error");
                    $("#continuesScaleMinValueId").parent().find(".help-block").empty();
    	...
    	if(minValue != ''){
    		if(parseInt(value) >= -10000 && parseInt(value) <= 10000){
    			if(parseInt(value) >= parseInt(minValue)+1 && parseInt(value) <= 10000){
                    ...
                    $("#continuesScaleMaxValueId").parent().find(".help-block").empty();
                    $("#continuesScaleMaxValueId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
                    "Please enter an integer number in the range (Min+1, 10000)"));
        		}
        	}else{
        		$("#continuesScaleMaxValueId").val('');
		...
		if(value != ''){
			if(parseInt(value) >= parseInt(minValue) && parseInt(value) <= parseInt(maxValue)){
	            ...
	            $(this).parent().find(".help-block").empty();
	             ...
	             $(this).parent().find(".help-block").empty();
	             $(this).parent().find(".help-block").append( $("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    	...
    	if(value !=''){
    		if(value >= 1 && value <= count){
                ...
                $("#textScalePositionId").parent().find(".help-block").empty();
                 ...
                 $("#textScalePositionId").parent().find(".help-block").empty();
                 $("#textScalePositionId").parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
    ...
    $('#timeIntervalDefaultId').datetimepicker({
		...
		if(durationTime && durationTime == '00:00'){
			durationFlag = false;
			$('#timeIntervalDefaultId').parent().addClass('has-error has-danger').find(".help-block").empty().append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
...
function saveQuestionStepQuestionnaire(item,callback){
	...
	if(quesstionnaireId && shortTitle){
		...
		if(!$('#stepShortTitle')[0].checkValidity()) {
			$("#stepShortTitle").parent().addClass('has-error has-danger').find(".help-block").empty().append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
 			...
 			$.ajax({
                 ...
                 success:  function getResponse(data){
                     ...
                     if('SUCCESS' != message){
                         ...
                         $("#statShortNameId").parent().find(".help-block").empty();
                         $("#statShortNameId").parent().find(".help-block").append( $("<ul><li> </li></ul>").attr("class","list-unstyled").text(
                                 short_title
                                 + " has already been used in the past."));
                         if (callback)
     						callback(false);
	...
	if(value != ''){
		if(minValue !='' && maxValue != ''){
			...
			if(parseInt(value) <= parseInt(maxFracDigits)){
	    		...
	    		$(item).parent().addClass("has-danger").addClass("has-error");
	            $(item).parent().find(".help-block").empty();
	            $(item).parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
		...
		$('.text-scale').each(function(){
			...
			if(diaplay_value != ''){
				if(valueArray.indexOf(diaplay_value.toLowerCase()) != -1) {
		            ...
		            $("#displayTextSclValue"+id).parent().find(".help-block").empty();
		            $("#displayTextSclValue"+id).parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
		...
		$('.value-picker').each(function(){
			...
			if(diaplay_value != ''){
				if(valueArray.indexOf(diaplay_value.toLowerCase()) != -1) {
		            ...
		            $("#displayValPickValue"+id).parent().find(".help-block").empty();
		            $("#displayValPickValue"+id).parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
	                  "The value should be unique "));
		        }
		        else
		        valueArray.push(diaplay_value.toLowerCase());
		...
		$('.image-choice').each(function(){
			...
			if(diaplay_value != ''){
				if(valueArray.indexOf(diaplay_value.toLowerCase()) != -1) {
		            ...
		            $("#displayImageChoiceValue"+id).parent().find(".help-block").empty();
		            $("#displayImageChoiceValue"+id).parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
	                  "The value should be unique "));
		        }
		        else
		        valueArray.push(diaplay_value.toLowerCase());
		...
		$('.text-choice').each(function(){
			...
			if(diaplay_value != ''){
				if(valueArray.indexOf(diaplay_value.toLowerCase()) != -1) {
		            ...
		            $("#displayTextChoiceValue"+id).parent().find(".help-block").empty();
		            $("#displayTextChoiceValue"+id).parent().find(".help-block").append($("<ul><li> </li></ul>").attr("class","list-unstyled").text(
	                  "The value should be unique "));
		        }
		        else
		        valueArray.push(diaplay_value.toLowerCase());
...
function addVariable(item){
	...
	var addVar = "<div class='numeric__row display__flex__base' id='" + (parseInt(v)) + "'>"+
				 ...
				 "         <option value='RDE'>Response Data Element (x)</option>"+
				 "      </select>"+
				 "		<div class='mt-sm black-xs-f italic-txt red-txt' id='inputTypeErrorValueId" + (parseInt(v)) + "' style='display: none;'></div>"+
				 "      <div class='help-block with-errors red-txt'></div>"+
				 ...
				 "   </div>"+
				 "   <div class='form-group sm__in add_var_hide'>"+
				 "      <input type='text' id='constantValId" + (parseInt(v)) + "' index='" + (parseInt(v)) + "' class='constant form-control add_var_hide' onkeypress='return isNumberKey(event)'/>"+
				 "   </div>"+
				 "   <div class='form-group sm__in'>"+
...
function validateSingleResponseDataElement(){
	...
	if($("#formulaBasedLogicId").is(":checked")){
		...
		$('.numeric__section').each(function(i){
		    ...
		    if(!isSingle){
		    	$('#alertMsg').show();
			    $("#alertMsg").removeClass('s-box').addClass('e-box').text("RDE (x) should be used only once.");
