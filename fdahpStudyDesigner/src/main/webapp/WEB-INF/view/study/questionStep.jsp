               ...
               <div class="col-md-6 pl-none">
                  ...
                  <div class="form-group">
                     <input autofocus="autofocus" type="text" custAttType="cust" class="form-control" name="stepShortTitle" id="stepShortTitle" value="${fn:escapeXml(questionnairesStepsBo.stepShortTitle)}" 
                       <c:if test="${not empty questionnairesStepsBo.isShorTitleDuplicate && (questionnairesStepsBo.isShorTitleDuplicate gt 1)}"> disabled</c:if> required maxlength="15"/>
            ...
            <div class="col-md-6 col-lg-4 p-none">
               ...
               <div class="form-group">
                  <input type="text" custAttType="cust" class="form-control requireClass" name="questionsBo.statShortName" id="statShortNameId" value="${fn:escapeXml(questionnairesStepsBo.questionsBo.statShortName)}" 
                     <c:if test="${not empty questionnairesStepsBo.questionsBo.isStatShortNameDuplicate && (questionnairesStepsBo.questionsBo.isStatShortNameDuplicate gt 1)}"> disabled</c:if> maxlength="20">
               	  <div class="help-block with-errors red-txt"></div>
