        ...
        <div>
            ...
            <div>
                <div class="form-group">
                    <input type="text" class="form-control lang-specific" name="displayName"
                           id="displayName"
                    ...
                    <div class="col-md-3 col-lg-3 p-none mr-lg">
                        ...
                        <div class="form-group">
                            <input type="text" id="playspeedId" class="form-control"
                                   ...
                                   required onkeypress="return isNumberFloat(event)"/>
                            <div class="help-block with-errors red-txt"></div>
                        </div>
                    </div>
                ...
                <c:if test="${taskMasterAttributeBo.orderByTaskType eq 8}">
                    ...
                    <div class="pl-xlg ml-xs bor-l-1-gray mt-lg">
                            ...
                            <div
                                ...
                                <div class="pb-lg">
                                    <div class="gray-xs-f mt-md mb-sm">
                                        Time range for the chart<span class="requiredStar">*</span>
                                        <span
                                    ...
                                    <div class="add_notify_option form-group">
                                        <select
                                                ...
                                                id="chartId"
                                                name="taskAttributeValueBos[7].timeRangeChart"
                                                title="Select">
                                ...
                                <div class="pb-lg">
                                    ...
                                    <div class="form-group">
										<span class="radio radio-info radio-inline p-45"> <input
                                            ...
                                            class="rollbackRadioClass" type="radio"
                                            id="inlineRadio2"
                                    ...
                                    <div class="add_notify_option">
                                        <div class="form-group">
                                            <input type="text"
                                                   ...
                                                   name="taskAttributeValueBos[7].titleChat"
                                                   maxlength="30"/>
                                            <div class="help-block with-errors red-txt"></div>
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <input type="text"
                                           class="form-control requireClass lang-specific"
                                           id="displayStat1"
                                           name="taskAttributeValueBos[7].displayNameStat"
                                           maxlength="50"/>
                                    <div class="help-block with-errors red-txt"></div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="gray-xs-f mb-sm">
                                    Display Units (e.g. hours) <small>(15 characters
                                    max)</small><span
                                        class="requiredStar"> *</span>
                                </div>
                                <div class="add_notify_option">
                            ...
                            <div>
                                ...
                                <div class="add_notify_option form-group">
                                    <select
                                            ...
                                            title="Select" id="uploadTypeStat1"
                                            name="taskAttributeValueBos[7].uploadTypeStat">
                                ...
                                <div class="pb-lg">
                                    ...
                                    <div class="add_notify_option form-group">
                                        <select
                                                class="selectpicker aq-select aq-select-form elaborateClass frequencyIdList elaborateClass requireClass"
                                                id="chartId1"
                                                name="taskAttributeValueBos[8].timeRangeChart"
                                                title="Select">
                                            <option value="" selected disabled>Select</option>
                                            <c:forEach items="${timeRangeList}" var="timeRangeAttr">
                                                <option value="${timeRangeAttr}">${timeRangeAttr}</option>
                                ...
                                <div class="bor-b-dash">
                                    ...
                                    <div class="add_notify_option">
                                        <div class="form-group">
                                            <input type="text"
                                                   class="form-control requireClass lang-specific"
                                                   name="taskAttributeValueBos[8].titleChat"
                                                   maxlength="30"/>
                                            <div class="help-block with-errors red-txt"></div>
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <input type="text"
                                           class="form-control requireClass lang-specific"
                                           id="displayStat2"
                                           name="taskAttributeValueBos[8].displayNameStat"
                                           maxlength="50"/>
                                    <div class="help-block with-errors red-txt"></div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="add_notify_option form-group">
                                    <select
                                            class="selectpicker aq-select aq-select-form elaborateClass requireClass"
                                            title="Select" id="uploadTypeStat2"
                                            name="taskAttributeValueBos[8].uploadTypeStat">
                                        <c:forEach items="${statisticImageList}"
                                                   var="statisticImage">
                                            <option value="${statisticImage.statisticImageId}">${statisticImage.value}</option>
                                        </c:forEach>
                                ...
                                <div class="pb-lg">
                                    ...
                                    <div class="add_notify_option form-group">
                                        <select
                                                class="selectpicker aq-select aq-select-form elaborateClass frequencyIdList elaborateClass requireClass"
                                                id="chartId2"
                                                name="taskAttributeValueBos[9].timeRangeChart"
                                                title="Select">
                                            <option value="" selected disabled>Select</option>
                                            <c:forEach items="${timeRangeList}" var="timeRangeAttr">
                                                <option value="${timeRangeAttr}">${timeRangeAttr}</option>
                                ...
                                <div class="bor-b-dash">
                                    ...
                                    <div class="add_notify_option">
                                        <div class="form-group">
                                            <input type="text"
                                                   class="form-control requireClass lang-specific"
                                                   name="taskAttributeValueBos[9].titleChat"
                                                   maxlength="30"/>
                                            <div class="help-block with-errors red-txt"></div>
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <input type="text"
                                           class="form-control requireClass lang-specific"
                                           id="displayStat3"
                                           name="taskAttributeValueBos[9].displayNameStat"
                                           maxlength="50"/>
                                    <div class="help-block with-errors red-txt"></div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="add_notify_option form-group">
                                    <select
                                            class="selectpicker aq-select aq-select-form elaborateClass requireClass"
                                            title="Select" id="uploadTypeStat3"
                                            name="taskAttributeValueBos[9].uploadTypeStat">
                                        <c:forEach items="${statisticImageList}"
                                                   var="statisticImage">
                                            <option value="${statisticImage.statisticImageId}">${statisticImage.value}</option>
                                        </c:forEach>
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 1 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        ...
                        <div class="col-md-3 col-lg-3 p-none mr-lg">
                            ...
                            <div class="form-group">
                                <input type="text" id="initialspanId" class="form-control"
                                       name="taskAttributeValueBos[0].attributeVal" maxlength="2"
                                       required value="${taskValueAttributeBo.attributeVal}"
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 3 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        ...
                        <div class="col-md-3 col-lg-3 p-none mr-lg ml-lg">
                            ...
                            <input type="hidden" name="taskAttributeValueBos[2].attributeValueId"
                                   value="${taskValueAttributeBo.attributeValueId}">
                            <input type="hidden"
                                   name="taskAttributeValueBos[2].activeTaskMasterAttrId"
                                   value="${taskMasterAttributeBo.masterId}">
                            <input type="hidden" name="taskAttributeValueBos[2].addToDashboard"
                                   value="${taskMasterAttributeBo.addToDashboard}">
                            <div class="form-group">
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 4 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        ...
                        <div class="col-md-3 col-lg-3 p-none mr-lg">
                            ...
                            <input type="hidden" name="taskAttributeValueBos[3].attributeValueId"
                                   value="${taskValueAttributeBo.attributeValueId}">
                            <input type="hidden"
                                   name="taskAttributeValueBos[3].activeTaskMasterAttrId"
                                   value="${taskMasterAttributeBo.masterId}">
                            <input type="hidden" name="taskAttributeValueBos[3].addToDashboard"
                                   value="${taskMasterAttributeBo.addToDashboard}">
                            <div class="form-group">
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 5 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        ...
                        <div class="col-md-3 col-lg-3 p-none mr-lg ml-lg">
                            ...
                            <input type="hidden" name="taskAttributeValueBos[4].attributeValueId"
                                   value="${taskValueAttributeBo.attributeValueId}">
                            <input type="hidden"
                                   name="taskAttributeValueBos[4].activeTaskMasterAttrId"
                                   value="${taskMasterAttributeBo.masterId}">
                            <input type="hidden" name="taskAttributeValueBos[4].addToDashboard"
                                   value="${taskMasterAttributeBo.addToDashboard}">
                            <div class="form-group">
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 6 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        <div class="col-md-3 col-lg-3 p-none mr-lg ml-lg">
                            ...
                            <input type="hidden" name="taskAttributeValueBos[5].attributeValueId"
                                   value="${taskValueAttributeBo.attributeValueId}">
                            <input type="hidden"
                                   name="taskAttributeValueBos[5].activeTaskMasterAttrId"
                                   value="${taskMasterAttributeBo.masterId}">
                            <input type="hidden" name="taskAttributeValueBos[5].addToDashboard"
                                   value="${taskMasterAttributeBo.addToDashboard}">
                            <div class="form-group">
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 7 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        ...
                        <div class="col-md-3 col-lg-3 p-none">
                            ...
                            <input type="hidden" name="taskAttributeValueBos[6].attributeValueId"
                                   value="${taskValueAttributeBo.attributeValueId}">
                            <input type="hidden"
                                   name="taskAttributeValueBos[6].activeTaskMasterAttrId"
                                   value="${taskMasterAttributeBo.masterId}">
                            <input type="hidden" name="taskAttributeValueBos[6].addToDashboard"
                                   value="${taskMasterAttributeBo.addToDashboard}">
                            <div class="form-group">
                            <span class="radio radio-info radio-inline p-45">
                                ...
                                <input type="radio" id="inlineRadio8"
                                       ...
                                       name="taskAttributeValueBos[6].attributeVal" value="N"
                                       required
                                       <c:if test="${empty taskValueAttributeBo.attributeVal  || empty taskValueAttributeBo}">checked</c:if> ${taskValueAttributeBo.attributeVal eq 'N'?'checked':""}>
                                <label for="inlineRadio8">No</label>
                            </span>
                                <div class="help-block with-errors red-txt"></div>
                            </div>
                        ...
                        <div class="pl-xlg ml-xs bor-l-1-gray mt-lg">
                            <div class="chartSection" style="display:none">
	                            ...
	                            <span class="checkbox checkbox-inline">
	                                <input type="checkbox"
                                           id="${taskMasterAttributeBo.attributeName}_chart_id"
                                           name="taskAttributeValueBos[7].addToLineChart"
                                           <c:if test="${taskValueAttributeBo.addToLineChart==true}">checked</c:if>
                                ...
                                <div class="addLineChartBlock_${taskMasterAttributeBo.attributeName}"
                                    ...
                                    <div class="pb-lg">
                                        <div class="gray-xs-f mt-md mb-sm">Time range for the
                                            chart<span class="requiredStar"> *</span> <span
                                                    class="ml-xs sprites_v3 filled-tooltip"
                                                    data-toggle="tooltip"
                                                    title="The options available here depend on the scheduling frequency set for the activity. For multiple-times-a-day and custom- scheduled activities, the chart's X axis divisions will represent runs. For the former case, the chart will display all runs for the day while for the latter, the chart will display a max of 5 runs at a time."></span>
                                        </div>
                                    ...
                                    <div class="bor-b-dash">
                                        <div class="gray-xs-f mb-sm">Title for the chart <small>(30
                                            characters max)</small><span
                                                class="requiredStar"> *</span>
                                        </div>
                                        <div class="add_notify_option">
                                            <div class="form-group">
                            ...
                            <div>
                                ...
                                <div class="addLineStaticBlock_${taskMasterAttributeBo.attributeName}"
                                    ...
                                    <div>
                                        <div class="gray-xs-f mb-sm">Short name <small>(20
                                            characters max)</small><span
                                                class="requiredStar"> *</span></div>
                                        <div class="add_notify_option">
                                            <div class="form-group statShortTitleClass">
                                    ...
                                    <div>
                                        <div class="gray-xs-f mb-sm">Display name for the Stat (e.g.
                                            Total Hours of Activity Over 6 Months) <small> (50
                                                characters max)</small><span
                                                    class="requiredStar"> *</span></div>
                                        <div class="form-group">
                                            <input type="text"
                                    ...
                                    <div>
                                        <div class="gray-xs-f mb-sm">Display Units (e.g. hours)
                                            <small>(15 characters max)</small><span
                                                    class="requiredStar"> *</span></div>
                                        <div class="add_notify_option">
                                            <div class="form-group">
                                                <input type="text" class="form-control requireClass"
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div class="gray-xs-f mb-sm">Formula for to be
                                                applied<span class="requiredStar"> *</span></div>
                                            <div class="form-group">
                                                <select class="selectpicker aq-select aq-select-form elaborateClass requireClass"
                                                        title="Select"
                                                        id="formulaAppliedStat4"
                                                        name="taskAttributeValueBos[7].formulaAppliedStat">
                                                    <c:forEach items="${activetaskFormulaList}"
                                                               var="activetaskFormula">
                    ...
                    <c:if test="${taskMasterAttributeBo.orderByTaskType eq 9 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
                        ...
                        <div class="pl-xlg ml-xs bor-l-1-gray mt-lg">
                            ...
                            <div class="addLineStaticBlock_${taskMasterAttributeBo.attributeName}"
                                    ...
                                    <div class="add_notify_option">
                                        <div class="form-group statShortTitleClass">
                                            ...
                                            <input autofocus="autofocus" type="text"
                                                   ...
                                                   exist="${taskValueAttributeBo.useForStatistic==true?'Y':'N'}"
                                                   dbid="${taskValueAttributeBo.attributeValueId}"
                                                   custAttType="cust" id="identifierId2"
                                                   name="taskAttributeValueBos[8].identifierNameStat"
                                                   maxlength="20"
                                                   value="${fn:escapeXml(taskValueAttributeBo.identifierNameStat)}"
                                                    <c:if test="${not empty taskValueAttributeBo.isIdentifierNameStatDuplicate && (taskValueAttributeBo.isIdentifierNameStatDuplicate gt 0)}"> disabled</c:if>/>
                                ...
                                <div>
                                    <div>
                                        <div class="gray-xs-f mb-sm">Stat Type for image
                                            display<span class="requiredStar"> *</span></div>
                                        <div class="add_notify_option form-group">
                                            <select class="selectpicker  aq-select aq-select-form elaborateClass requireClass"
                                                    title="Select"
                                                    id="uploadTypeStat5"
                                    ...
                                    <div class="add_notify_option">
                                        <div class="form-group statShortTitleClass">
                                            ...
                                            <input autofocus="autofocus" type="text"
                                                   ...
                                                   exist="${taskValueAttributeBo.useForStatistic==true?'Y':'N'}"
                                                   dbid="${taskValueAttributeBo.attributeValueId}"
                                                   custAttType="cust" id="identifierId3"
                                                   name="taskAttributeValueBos[9].identifierNameStat"
                                                   maxlength="20"
                                                   value="${fn:escapeXml(taskValueAttributeBo.identifierNameStat)}"
                                                    <c:if test="${not empty taskValueAttributeBo.isIdentifierNameStatDuplicate && (taskValueAttributeBo.isIdentifierNameStatDuplicate gt 0)}"> disabled</c:if>/>
