...
<body class="loading background__img">
		...
		<div class="login__container">
			<div class="">
				...
				<form:form id="accessCodeForm" data-toggle="validator" role="form"
					action="validateAccessCode.do" method="post" autocomplete="off">

					<div id="errMsg" class="error_msg">${errMsg}</div>
					<div id="sucMsg" class="suceess_msg">${sucMsg}</div>
					<c:if test="${isValidToken}">
						<p class="white__text">To complete your email verification
							process, kindly use the access code provided on your email.</p>
						<div class="mb-lg form-group">
					...
					<c:if test="${not isValidToken}">
						<p class="passwordExp">
							...
							Activation Link is either expired or invalid.
						</p>
					</c:if>
					<div>
	...
	<script type="text/javascript"
		src="/fdahpStudyDesigner/js/jquery.password-validator.js"></script>
