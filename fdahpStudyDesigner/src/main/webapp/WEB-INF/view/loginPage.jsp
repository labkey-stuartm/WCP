		...
		<div class="login__container">
			<div class="cs-model-box hide askSignInCls">
				...
				<div>
					...
					<ul>
						<li>You Are Accessing a U.S. Government Information System</li>
						<li>Usage Of This Information System May Be Monitored,
							Recorded, And Subject To Audit</li>
						<li>Unauthorized Use Of This Information System Is Prohibited
							And Subject To Criminal And Civil Penalties</li>
						<li>Use Of This Information System Indicates Consent To
							Monitoring And Recording</li>
					</ul>

					<div>
						By clicking Sign In, you agree to the the above-mentioned points
						as well as to the US FDA MyStudies Management Portal <a
							href="https://www.fda.gov/AboutFDA/AboutThisWebsite/WebsitePolicies/"
							class="" target="_blank">Terms</a> and <a
							href="https://www.fda.gov/AboutFDA/AboutThisWebsite/WebsitePolicies/#privacy"
							class="" target="_blank">Privacy Policy</a>
					</div>

					<div class="mt-lg">
						<button id="loginBtnId" type="button"
							class="btn btn-primary blue-btn float__left">Sign In</button>
						<button id="cancelbtn" type="button"
							class="btn btn-default gray-btn ml-sm float__left">Cancel</button>
					</div>
				</div>
			</div>
			...
			<div class="login-box">
				...
				<form:form id="loginForm" data-toggle="validator" role="form"
					...
					<div class="login pt-xlg">
						<div class="mb-lg form-group">
							<input type="text" class="input-field wow_input" id="email"
								name="username" data-pattern-error="Email address is invalid"
						...
						<div class="mb-lg form-group">
							<button type="button" class="btn lg-btn" id="siginNoteBtnId">SIGN
								IN</button>
						</div>
						<div class="pb-md pt-xs">
							<span class="white__text">Forgot Password? </span> <a
								id="forgot_pwd" class="gray-link white__text"
					...
					<div class="pwd dis-none">
						<div class="mb-lg">
							...
							<div class="mt-md white__text">Enter your Email address to
								get a link to reset your password</div>
						</div>
						<div class="mb-lg form-group">
							<input type="text" class="input-field wow_input" id="emailReg"
								name="email" maxlength="100" placeholder="Email Address"
								data-pattern-error="Email address is invalid" required
								maxlength="100"
								pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
							<div class="help-block with-errors red-txt"></div>
						</div>
						...
						<div class="pt-xs">
							<a id="login" class="gray-link white__text"
		...
		<div class="footer">
			<div>
				<span id="copyright">Copyright © 2017 FDA</span><span><a
					href="https://www.fda.gov/AboutFDA/AboutThisWebsite/WebsitePolicies/"
					class="" target="_blank">Terms</a></span><span><a
					href="https://www.fda.gov/AboutFDA/AboutThisWebsite/WebsitePolicies/#privacy"
					class="" target="_blank">Privacy Policy</a></span>
			</div>
		</div>
		<!-- new login -->
	</div>
